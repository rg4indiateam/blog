        ...
        <SiteNavLeft className="site-nav-left">
          ...
          <SiteNavContent css={[this.state.showTitle ? HideNav : '']}>
            <ul css={NavStyles} role="menu">
              ...
              <li role="menuitem">
                <a
                  href="https://rg4indiateam.typeform.com/to/sLoJ1w"
                  target="_blank"
                >
                  Join Team
                </a>
              ...
              <li role="menuitem">
                <a
                  href="https://rg4indiateam.typeform.com/to/TeCFdK"
                  target="_blank"
                >
                  2024 Manifesto Ideas
                </a>
              </li>
              <li role="menuitem">
                <a
                  href="https://rg4indiateam.typeform.com/to/lWzYvv"
                  target="_blank"
                >
                  Write to Rahul
                </a>
